...
createDisplayUers = (nom, prenom, dateInscrip, emailRec) => {
    ...
    newSection.appendChild(createElm1('p', 'date d\'incription :' + ' ' + dateInscrip, 'class', 'bloc__login__form--label--style--create--post'));
    ...
    newDiv.appendChild(createElm2('button', 'Modifier le mot de passe', 'id', 'btn_modif_profil_user', 'class', 'bloc__form--btn-2'));
...
createFormModifPassword = () => {
    ...
    const mainUsers = document.getElementById('main_compe_user');
    const newForm = mainUsers.appendChild(createElm2('form', '', 'id', 'form_modif_password', 'class', 'bloc_section_form--flex')); //display--none
    ...
    newForm.appendChild(createElm2('p', '1 des champs n\'est pas rempli correctement !', 'id', 'erreur4', 'class', 'bloc__form--font--erreur'));
